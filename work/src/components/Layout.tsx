        ...
        <div className="flex items-center justify-between gap-2 border-b border-line/10 px-3 py-3.5">
          {!collapsed ? (
            ...
            <span
              aria-hidden="true"
              title={t("brand")}
              className="mx-auto inline-flex h-8 w-8 items-center justify-center rounded-md border border-gold/40 bg-canvas font-display text-sm uppercase tracking-[0.18em] text-gold"
            >
              A
            </span>
          )}
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `group relative flex items-center gap-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                          ...
                          isActive
                            ? "border border-gold/40 bg-gold/10 text-gold shadow-gold"
                            : "border border-transparent text-muted hover:bg-surface/60 hover:text-fg"
                        }`
                      }
                    >
                      {({ isActive }) => (
